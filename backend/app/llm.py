...
"""
    ...
    def generate_recommendations(self, user_profile, listening_history, candidate_tracks, count=5):
        ...
        system_prompt = (
            ...
            "CRITICAL: Ensure artist and track diversity! NEVER queue multiple tracks from the same artist. Every track MUST be from a different artist. "
            "CRITICAL: DO NOT queue multiple versions of the same song (e.g. avoid queuing 'Song X (Live)' if 'Song X' is already in the history or batch). "
